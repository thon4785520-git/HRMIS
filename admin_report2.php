        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 page-header">
                    <h1 class="h2"><i class="fas fa-file-alt text-secondary"></i> §ҹػŢ</h1>
                </div>

                <div class="card card-custom">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <h5 class="font-weight-bold">Ẻ§ҹšҷӧҹ Сҵҧ </h5>
                            <p class="mb-1">
                                <strong>ѧѴ:</strong> 
                                <?php
                                if($_POST['DEPARTMENTID'] != 4785520){
                                    ...
                                    echo "<span class='text-primary'>ԷҪѯʧ</span>";
                                }
                                ?>
                            </p>
                            <p class="mb-1">
                                <strong>ͧ:</strong> §ҹػһԺѵҪâͧҪ ѡҹԷ ѡҹҪ ١ҧШ оѡҹШӵѭ
                            </p>
                            <p class="mb-1">
                                <strong>ѹ:</strong> <span class="text-info"><?php echo DateThai($_POST['date1']); ?></span> 
                                <strong>֧</strong> <span class="text-info"><?php echo DateThai($_POST['date2']); ?></span>
                            </p>
                            <p class="mb-0"><strong>¹:</strong> ͸ԡú</p>
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-hover table-report">
                                <thead class="bg-header-light">
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-warning">繡Ѻ</th>
                                        <th colspan="2">Ҫ</th>
                                        <th colspan="2">Ҥʹ</th>
                                        <th colspan="2">ػ</th>
                                        <th colspan="2">WFH</th>										
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- Ordination Leave (Type 8) -->
                                        <td class="text-center">
                                            <?php
                                            $count=0; $days=0;
                                            $sql1="select * from absent where STAFFID=$sid and type=8 and date1 between '$date1' and '$date2' and approve=1";
                                            $res1=mysql_query($sql1);
                                            while($ln1=mysql_fetch_array($res1)){ $count++; $days+=$ln1['amount']; }
                                            echo $count > 0 ? $count : "-";
                                            ?>
                        ...
                        <div class="mt-4 text-center btn-print-hide">
                            <a href="admin_report.php" class="btn btn-secondary shadow-sm">
                                <i class="fas fa-arrow-left"></i> Ѻ˹͡§ҹ
                            </a> 
