...
$sql="INSERT INTO staff (STAFFID, USERLOGIN, PREFIXNAME, STAFFNAME, STAFFSURNAME, DEPARTMENTID, STAFFTYPE, POSITIONNAME, STAFFGROUP) VALUES ($staffid, '$_POST[USERLOGIN]', '$_POST[PREFIXNAME]', '$_POST[STAFFNAME]', '$_POST[STAFFSURNAME]', $_POST[DEPARTMENTID], '$_POST[STAFFTYPE]', '$_POST[POSITIONNAME]', '$_POST[STAFFGROUP]')";
//echo "$sql";
$res=mysql_query($sql)or die(mysql_error());

if($res){
	echo "<div class='alert alert-success'>";
	echo "<strong>เพิ่มข้อมูลสำเร็จ</strong><br>";
	echo "<a href='admin_view_staff.php' class='btn btn-sm btn-info'>กลับหน้าหลัก</a>";
	echo "</div>";
}else{   
	echo "<div class='alert alert-danger'>";
	echo "<strong>เพิ่มข้อมูลไม่สำเร็จ !</strong> <br>";
