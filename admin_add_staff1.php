        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 page-header">
                    <h1 class="h2"><i class="fas fa-user-plus text-success"></i> źؤҡ</h1>
                </div>
                    ...
                    <div class="col-lg-10">
                        <div class="card card-custom">
                            <div class="card-header card-header-custom">
                                <i class="fas fa-address-card"></i> Ẻŧ¹ؤҡ
                            </div>
                            <div class="card-body">
                                <form method="POST" action="admin_add_staff2.php" id="form1">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control required" type="text" name="USERLOGIN" placeholder="͡ Username">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <input class="form-control required" type="text" name="PREFIXNAME" placeholder="/ҧ/ҧ">
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label> <span class="text-danger">*</span></label>
                                            <input class="form-control required" type="text" name="STAFFNAME" placeholder="кتͨԧ">
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label>ʡ <span class="text-danger">*</span></label>
                                            <input class="form-control required" type="text" name="STAFFSURNAME" placeholder="кعʡ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>˹ <span class="text-danger">*</span></label>
                                        <input class="form-control required" type="text" name="POSITIONNAME" placeholder="кص˹觧ҹ">
                                    </div>
