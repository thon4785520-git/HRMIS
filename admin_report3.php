        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 page-header btn-print-hide">
                    <h1 class="h2"><i class="fas fa-chart-line text-success"></i> §ҹһԺѵԧҹ</h1>
                </div>
                ...
                <div class="card card-custom">
                    <div class="card-body">
                        ...
                        <div class="text-center mb-4">
                            <h4 class="font-weight-bold text-dark">§ҹšһԺѵԧҹ</h4>
                            <h5 class="text-muted">ҧѹ <span class="text-primary"><?php echo isset($_POST['date1']) ? $_POST['date1'] : '-'; ?></span> ֧ <span class="text-primary"><?php echo isset($_POST['date2']) ? $_POST['date2'] : '-'; ?></span></h5>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center text-muted">
                                            ...
                                            <?php if($e > 0) echo "<small class='d-block text-warning'>繡Ѻ: $e</small>"; ?>
                                        </td>
                                    </tr>
                                    <?php 
                                        }
                                    } else {
                                        echo "<tr><td colspan='6' class='text-center py-4 text-muted'>辺źؤҡ</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
