        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 page-header">
                    <h1 class="h2"><i class="fas fa-edit text-info"></i> 䢡ŧ͡һԺѵԧҹ</h1>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="admin_edit_work1.php?id=<?php echo $ln['STAFFID']; ?>&dated=<?php echo $ln['dated']; ?>" class="btn btn-sm btn-warning text-white jax shadow-sm" title="">
                                        ...
                                        <td>
                                            ...
                                            if(Timing($ln['timein']) != 0 && Timing($ln['timein']) < 8.31) echo "<span class='badge badge-status badge-soft-success'><i class='fas fa-check-circle'></i> һ</span>";
                                            if(Timing($ln['timein']) != 0 && Timing($ln['timein']) > 8.30) echo "<span class='badge badge-status badge-soft-danger'><i class='fas fa-exclamation-circle'></i> </span>";
                                            if(Timing($ln['timein']) == 0 && Timing($ln['timeout']) == 0) echo "<span class='badge badge-status badge-soft-secondary'><i class='fas fa-times-circle'></i> </span>";
                                            if(Timing($ln['timein']) == 0 && Timing($ln['timeout']) != 0) echo "<span class='badge badge-status badge-soft-info'><i class='fas fa-question-circle'></i> </span>";
                                            if(Timing($ln['timein']) > 0 && Timing($ln['timeout'])== 0) echo "<span class='badge badge-status badge-soft-info'><i class='fas fa-question-circle'></i> 繡Ѻ</span>";
                                    ...
                                    <?php 
                                        ...
                                        echo "<tr><td colspan='5' class='text-center py-4 text-muted'>辺šŧѹ</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
