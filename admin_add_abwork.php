...
<form action="admin_add_abwork2.php" method="post" name="form1" id="form1">

<div class="form-group">
         <label>วันที่ปฏิบัติงาน</label>
         <input class="form-control required" type="text" name="dated" id="dated" value="<?=Date('Y-m-d')?>">
</div>
...
<tr>
	<td><?=$ln[name_th]?></td>
	<td><input type="checkbox" name="ch[]" value="<?=$ln[0]?>"></td>
</tr>
<? }?>
</table>
