        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 page-header">
                    <h1 class="h2"><i class="fas fa-chart-pie text-secondary"></i> к§ҹŢ</h1>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card card-custom">
                            <div class="card-header card-header-blue">
                                <i class="fas fa-file-alt"></i> §ҹš
                            </div>
                            <div class="card-body">
                                <form method="POST" action="admin_report2.php" id="form1" target="_blank">
                                    <div class="form-group">
                                        <label class="font-weight-bold">ؤҡ</label>
                                        <select name="STAFFTYPE" class="form-control">
                                            <option value="0">--- ʴ ---</option>
                                            <option value="1">Ҫ</option>
                                            <option value="2">١ҧШ</option>
                                            <option value="3">ѡҹҪ</option>
                                            <option value="4">ѡҹԷ</option>
                                            <option value="5">ѡҹШӵѭ</option>
                                            <option value="6">ѡҹҧҺԡ</option>	
                                        </select>
                                    </div>

                                    <div class="form-group">
                                        <label class="font-weight-bold">˹§ҹ</label>
                                        <select name="DEPARTMENTID" class="form-control">
                                            <option value="4785520">--- ʴ ---</option>
                                            <?php
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label class="font-weight-bold">ѹ</label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="font-weight-bold">֧ѹ</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                                </div>
                                    ...
                                    <div class="mt-3">
                                        <button type="submit" class="btn btn-primary btn-custom shadow-sm"><i class="fas fa-search"></i> §ҹ</button>
                                        <button type="reset" class="btn btn-secondary btn-custom shadow-sm ml-2"><i class="fas fa-undo"></i> ҧ</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card card-custom">
                            <div class="card-header card-header-green">
                                <i class="fas fa-clock"></i> §ҹšһԺѵԧҹ
                            </div>
                            <div class="card-body">
                                <form method="POST" action="admin_report3.php" id="form2" target="_blank">
                                    <div class="alert alert-light border mb-4">
                                        <i class="fas fa-info-circle text-success"></i> ͡ǧҷͧõǨͺѵԡŧ
                                    </div>
                                    ...
                                    <div class="mt-3 pt-4">
                                        <button type="submit" class="btn btn-success btn-custom shadow-sm"><i class="fas fa-search"></i> §ҹ</button>
                                        <button type="reset" class="btn btn-secondary btn-custom shadow-sm ml-2"><i class="fas fa-undo"></i> ҧ</button>
                                    </div>
                                </form>
                            </div>
