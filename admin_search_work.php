        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 page-header">
                    <h1 class="h2"><i class="fas fa-search text-primary"></i> ҢšһԺѵԧҹ</h1>
                </div>
                            ...
                            <div class="form-row align-items-end">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="search" class="form-control custom-select">
                                        <option value="STAFFNAME"> - ʡ ؤҡ</option>
                                    </select>
                                </div>
                ...
                <div class="card card-custom">
                    <div class="card-header card-header-blue">
                        <i class="fas fa-user-cog"></i> ʹѺʹع (ŧһԺѵԧҹ)
                    </div>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if($A1 != 0.0 && $A1<=8.30 && $B1>=16.30 && $B1 != 0.0) echo "<span class='badge badge-status badge-soft-success'><i class='fas fa-check-circle'></i> һ</span>";			
                                            if($A1>8.30) echo "<span class='badge badge-status badge-soft-danger'><i class='fas fa-exclamation-circle'></i> </span>";
                                            if($A1==0.0 && $B1!=0.0) echo "<span class='badge badge-status badge-soft-warning'>ŧ</span>";
                                            if($A1==0.0 && $B1==0.0) echo "<span class='badge badge-status badge-soft-secondary'>Ҵҹ</span>";
                                            if($A1!=0.0 && $B1<16.30 && $B1!=0.0) echo "<span class='badge badge-status badge-soft-info'>ŧ͡͹</span>";
                                            if($A1!=0.0 && $B1==0.0) echo "<span class='badge badge-status badge-soft-info'>ŧ͡</span>";			
                                            
                                            // Check Absent Record
                                            $sql1="select * from absent where STAFFID={$ln['STAFFID']} and '{$ln['dated']}' between date1 and date2";
                                            $res1=mysql_query($sql1);
                                            if(mysql_num_rows($res1) > 0) {
                                                echo "<div class='mt-1'><span class='badge badge-status badge-soft-purple'><i class='fas fa-briefcase'></i> /Ҫ/WFH</span></div>";
                                            }
                                    ...
                                    <?php 
                                        ...
                                        echo "<tr><td colspan='4' class='text-center py-3 text-muted'>辺</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
                ...
                <div class="card card-custom">
                    <div class="card-header card-header-green">
                        <i class="fas fa-chalkboard-teacher"></i> Ԫҡ (ŧԺѵԧҹ)
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:thon('boss_cog_work.php?id=<?php echo base64_encode($ln['STAFFID']); ?>&di=<?php echo base64_encode($ln['dated']); ?>')" class="btn btn-sm btn-outline-warning mt-1 py-0 px-2" title="ʶҹ">
