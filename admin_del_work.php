...
$sql="select * from staff where DEPARTMENTID IN (1,3,4,5,6,7,8,9,10,11,17,21,32,50,61,74,80,85,91,97,102,103,105,301,401)";
$res=mysql_query($sql);
while($ln=mysql_fetch_array($res)){
	$sql1="delete from work1 where dated='{$_GET['id']}' and STAFFID={$ln['STAFFID']}";
	$res1=mysql_query($sql1);
}

if($res){
	echo "<div class='alert alert-success'>";
	echo "<strong>źšһԺѵԧҹ</strong><br>";
	echo "<a href='admin_view_work.php' class='btn btn-sm btn-info'>Ѻ˹ѡ</a>";	
	echo "</div>";
}else{
	echo "<div class='alert alert-danger'>";
	echo "<strong>źšһԺѵԧҹ <br>";
