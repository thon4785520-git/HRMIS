...
if($_FILES['ch49'][name]!=""){
	...
	@move_uploaded_file($_FILES['ch49'][tmp_name],"file/$rand.pdf");
}else{
	$rand=$_POST['old'];
}

for($i=0;$i<count($_POST['ch48']);$i++){
	$x .= $_POST['ch48'][$i] . ",";
}

for($i=0;$i<count($_POST['ch50']);$i++){
	$y .= $_POST['ch50'][$i] . ",";
}

$sql="update controls set ch43='{$_POST['ch43']}', ch44='{$_POST['ch44']}', ch45='{$_POST['ch45']}', ch46='{$_POST['ch46']}', ch47='{$_POST['ch47']}', ch48='$x', ch49='$rand', ch50='$y' where STAFFID={$_POST['id']} ";
