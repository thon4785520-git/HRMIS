        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 page-header">
                    <h1 class="h2"><i class="fas fa-edit text-info"></i> ҷ١ź</h1>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    // Type Array
                                    $type_arr = array("","һ","ҡԨ","Ҿѡ͹","Ҫ","Ҥʹ","ػ","§ٺص","ѡ (§Դ-19)","СͺԸѨ");
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> 
                                            ...
                                            <a href="admin_store.php?id=<?php echo base64_encode($ln['id']); ?>" class="btn btn-warning action-btn text-white shadow-sm" title="">
