...
<head>
    ...
    <title>Edit Staff - Absent Database System</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 page-header">
                    <h1 class="h2"><i class="fas fa-user-edit text-warning"></i> 䢢źؤҡ</h1>
                </div>
                    ...
                    <div class="col-lg-10">
                        <div class="card card-custom">
                            <div class="card-header card-header-custom">
                                <i class="fas fa-address-card"></i> Ẻ䢢
                            </div>
                            <div class="card-body">
                                <form method="POST" action="admin_edit_staff2.php" id="form1">
                                    
                                    <div class="form-section-title"><i class="fas fa-building"></i> ѧѴк</div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>˹§ҹ <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Username (к MIS) <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-user-lock"></i></span></div>
                                                <input class="form-control required" type="text" name="USERLOGIN" value="<?php echo $rs['USERLOGIN']; ?>" placeholder="͡ Username">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-section-title"><i class="fas fa-id-card"></i> ǹ</div>
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            <label>ӹ˹ <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group col-md-5">
                                            <label>ʡ <span class="text-danger">*</span></label>
                                            <input class="form-control required" type="text" name="STAFFSURNAME" value="<?php echo $rs['STAFFSURNAME']; ?>">
                                        </div>
                                    </div>

                                    <div class="form-section-title"><i class="fas fa-briefcase"></i> ŵ˹觧ҹ</div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="STAFFGROUP" class="form-control">
                                                <option value="1" <?php if($rs['STAFFGROUP']==1) echo "selected"; ?>>Ҩ</option>
                                                <option value="2" <?php if($rs['STAFFGROUP']==2) echo "selected"; ?>>ʹѺʹع</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center mt-4">
                                        ...
                                        <a href="admin_view_staff.php" class="btn btn-secondary btn-lg shadow px-5 ml-3"><i class="fas fa-times"></i> ¡ԡ</a>
                                    </div>
