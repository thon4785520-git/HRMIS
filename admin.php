...
<? }else{?>
                ...
                <div class="card mb-4 shadow-sm border-0">
                    <div class="card-header bg-white font-weight-bold text-primary">
                        <i class="fas fa-clipboard-list"></i> สรุปวันลาอื่น ๆ (ปีงบประมาณ)
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr>
										...
										<td class="font-weight-bold text-success"><? echo (30-$ln1[0]);?></td>
                                    </tr>
                                   <tr>
  										<td>กิจ</td>
										<td>3</td>
										...
										<td class="font-weight-bold text-success"><? echo (3-$ln1[0]);?></td>
                                    </tr>	
                                   <tr>
  										<td>คลอดบุตร</td>
										<td>120</td>
										...
										<td class="font-weight-bold text-success"><? echo (120-$ln1[0]);?></td>
                                    </tr>	
                                  <tr>
  										<td>ช่วยเหลือภริยา/เลี้ยงดูบุตร</td>
										<td>15</td>
										<td>
											<?
										...
										<td class="font-weight-bold text-success"><? echo (15-$ln1[0]);?></td>
                                    </tr>																											
                                </tbody>
                            </table>
                        </div>
