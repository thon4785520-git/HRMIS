...
// Ͱҹ (ա connect  config.php ͷ)
include "config.php"; 

// ѧѹŧѹͤ͢ҡ (Optional Helper)
...
<head>
    ...
    <!--  jquery ԹѺ bootstrap 4 Ҩͧ CDN ҹҧ᷹ -->
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 d-md-block sidebar collapse" id="sidebarMenu">
                <div class="position-sticky">
                    <div class="list-group list-group-flush">
                        <a href="admin.php" class="active"><i class="fas fa-home"></i> ˹á</a>
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 page-header">
                    <h1 class="h2"><i class="fas fa-tachometer-alt text-warning"></i> кҹš</h1>
                    <div class="text-muted">ԷҪѯʧ</div>
                </div>

                <!-- Info Alert -->
                <div class="alert alert-custom shadow-sm" role="alert">
                    <h5 class="alert-heading"><i class="fas fa-info-circle"></i> Թյ͹Ѻк</h5>
                    <p class="mb-0">кҹš ҹ͢͹Ź Ѳͤдǡ Ǵ 繻Ѩغѹ ж١ͧࡳҵðҹ Ŵӫ͹ͧ͡</p>
                </div>

                <!-- Search Form -->
                <div class="card card-form">
                    <div class="card-body">
                        <h5 class="card-title text-primary mb-4"><i class="fas fa-search"></i> Ңѹ</h5>
                        <form method="POST" action="" id="form1">
                            <div class="form-row align-items-end">
                                <div class="col-md-5 mb-3">
                                    <label for="DEPARTMENTID">͡˹§ҹ</label>
                                    <select name="DEPARTMENTID" class="form-control" onChange="thon(this.value)" required>
                                        <option value="">--- ͡˹§ҹ ---</option>
                                        <?php
                                        //  config.php  include ҹ
                ...
                <div class="section-title">
                    źؤҡ: <span class="text-primary"><?php echo $ln['STAFFNAME'] . " " . $ln['STAFFSURNAME']; ?></span>
                </div>

                <!-- 1. Ҿѡ͹ (Fiscal Year) -->
                <div class="card mb-4 shadow-sm border-0">
                    <div class="card-header bg-white font-weight-bold text-success">
                        <i class="fas fa-umbrella-beach"></i> ػѹҾѡ͹ (էҳ)
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="stat-card bg-gradient-blue">
                                    <div class="card-body">
                                        <h5 class="card-title">Էѹ (չ)</h5>
                                        <h2 class="font-weight-bold"><?php echo $sith; ?> <small style="font-size: 1rem;">ѹ</small></h2>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="stat-card bg-gradient-orange">
                                    <div class="card-body">
                                        ...
                                        <h2 class="font-weight-bold"><?php echo $la_used; ?> <small style="font-size: 1rem;">ѹ</small></h2>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="stat-card bg-gradient-green">
                                    <div class="card-body">
                                        <h5 class="card-title"></h5>
                                        <h2 class="font-weight-bold"><?php echo $la_remain; ?> <small style="font-size: 1rem;">ѹ</small></h2>
                                    </div>
                ...
                <!-- 2.  (¡ѡҹ) -->
                <?php if($STAFFTYPE == 5){ // ѡҹԪҡ (.) ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow-sm mb-4">
                            <div class="card-header bg-info text-white"><i class="fas fa-briefcase"></i> ҡԨ (.)</div>
                            <div class="card-body text-center">
                                ...
                                ?>
                                <h3 class="text-info"><?php echo $sith_kij - $used_kij; ?> <small class="text-muted">/ <?php echo $sith_kij; ?> ѹ</small></h3>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm mb-4">
                            <div class="card-header bg-danger text-white"><i class="fas fa-procedures"></i> һ (.)</div>
                            <div class="card-body text-center">
                                <?php
                                $sith_sick = 15;
                                ...
                                ?>
                                <h3 class="text-danger"><?php echo $sith_sick - $used_sick; ?> <small class="text-muted">/ <?php echo $sith_sick; ?> ѹ</small></h3>
                                <div class="progress mt-2" style="height: 10px;">
...
?>
                ...
                <div class="card mb-4 shadow-sm border-0">
                    <div class="card-header bg-white font-weight-bold text-primary">
                        <i class="fas fa-clipboard-list"></i> ԴͺԹ (/Ԩ)
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <?php
                                            if($STAFFTYPE==1 || $STAFFTYPE==4) echo "/Ԩ";
                                            elseif($STAFFTYPE==5 || $STAFFTYPE==3) echo "";
                                            else echo "-";
                                            ?>
                                        </td>
                                        <td>
                                            <?php
                                            if($STAFFTYPE==1) echo "9  (23 ѹ)";
                                            if($STAFFTYPE==4) echo "6  (23 ѹ)";
                                            if($STAFFTYPE==5) echo "7.5 ѹ";
                                            if($STAFFTYPE==3) echo "15 ѹ";
                                            ?>
                                        </td>
                                        <td>
                                            <?php
                                            ...
                                            if($STAFFTYPE==1 || $STAFFTYPE==4){
                                                ...
                                                echo "<span class='badge badge-warning'>$c </span> <span class='badge badge-secondary'>$z ѹ</span>";
                                            }
                                            if($STAFFTYPE==5 || $STAFFTYPE==3){
                                                ...
                                                echo "<span class='badge badge-secondary'>$z ѹ</span>";
                                            }
                                            ?>
                                        </td>
                                        <td class="font-weight-bold text-success">
                                            <?php
                                            if($STAFFTYPE==1) echo (9-$c) . "  (" . (23-$z) . " ѹ )";
                                            if($STAFFTYPE==4) echo (6-$c) . "  (" . (23-$z) . " ѹ )";
                                            if($STAFFTYPE==5) echo (7.5-$z) . " ѹ";
                                            if($STAFFTYPE==3) echo (15-$z) . " ѹ";
                                            ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-weight-bold text-success"><?php echo (5-$z) . " ѹ"; ?></td>
                                    </tr>
                                    <?php } ?>
...
<?php }else{?>
                ...
                <div class="card mb-4 shadow-sm border-0">
                    <div class="card-header bg-white font-weight-bold text-primary">
                        <i class="fas fa-clipboard-list"></i> ػѹ  (էҳ)
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr>
										...
										<td>
											<?php
											$sql1="select sum(amount) from absent where STAFFID={$_POST['STAFFID']} and date1 between '2025-10-1' and '2026-3-31' and type in (1)";
											$res1=mysql_query($sql1);
											$ln1=mysql_fetch_array($res1);
											echo number_format($ln1[0]);
											?>
										</td>
										<td class="font-weight-bold text-success"><?php echo (30-$ln1[0]);?></td>
                                    </tr>
                                   <tr>
  										<td>Ԩ</td>
										<td>3</td>
										<td>
											<?php
											$sql1="select sum(amount) from absent where STAFFID={$_POST['STAFFID']} and date1 between '2025-10-1' and '2026-3-31' and type in (2)";
											$res1=mysql_query($sql1);
											$ln1=mysql_fetch_array($res1);
											echo number_format($ln1[0]);
											?>
										</td>
										<td class="font-weight-bold text-success"><?php echo (3-$ln1[0]);?></td>
                                    </tr>	
                                   <tr>
  										<td>ʹص</td>
										<td>120</td>
										<td>
											<?php
											$sql1="select sum(amount) from absent where STAFFID={$_POST['STAFFID']} and date1 between '2025-10-1' and '2026-3-31' and type in (5)";
											$res1=mysql_query($sql1);
											$ln1=mysql_fetch_array($res1);
											echo number_format($ln1[0]);
											?>
										</td>
										<td class="font-weight-bold text-success"><?php echo (120-$ln1[0]);?></td>
                                    </tr>	
                                  <tr>
  										<td>/§ٺص</td>
										<td>15</td>
										<td>
											<?php
											$sql1="select sum(amount) from absent where STAFFID={$_POST['STAFFID']} and date1 between '2025-10-1' and '2026-3-31' and type in (7)";
											$res1=mysql_query($sql1);
											$ln1=mysql_fetch_array($res1);
											echo number_format($ln1[0]);
											?>
										</td>
										<td class="font-weight-bold text-success"><?php echo (15-$ln1[0]);?></td>
                                    </tr>																											
                                </tbody>
                            </table>
                        </div>
