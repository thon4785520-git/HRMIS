...
<div class="page-header">
        <h3> <i class="fa fa-pencil text-success"></i> Сèҧ駷 4 </h3>
</div>
...
<div class="form-group">
		 ...
		 $x=explode(",", $rs[32]);
		 ?>
		<input type="checkbox" name="ch32[]" value="1" <?php if(in_array(1,$x))echo"checked";?>> MOU ͧͺԹ<br>
		<input type="checkbox" name="ch32[]" value="2" <?php if(in_array(2,$x))echo"checked";?>> šûԹͧҹѧ<br>
 		<input type="checkbox" name="ch32[]" value="3" <?php if(in_array(3,$x))echo"checked";?>> ѡҹþ¹<br>
		<input type="checkbox" name="ch32[]" value="4" <?php if(in_array(4,$x))echo"checked";?>> ŧҹҧԪҡ<br>
		<input type="checkbox" name="ch32[]" value="5" <?php if(in_array(5,$x))echo"checked";?>> ͡ûԺѵԧҹ<br>
</div>
<div class="form-group">
         <label>觨ҧ</label>
...
<div class="form-group">
         <label>ʶҹ</label><br>
		<input type="checkbox" name="ch34[]" value="1" <?php if(in_array(1,$y))echo"checked";?>> 觧ҹѧ<br>
		<input type="checkbox" name="ch34[]" value="2" <?php if(in_array(2,$y))echo"checked";?>> 觹Եԡ<br>
</div>
